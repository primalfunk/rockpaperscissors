...
function StartGame(rps) {
  ...
  document.getElementById('stats').innerHTML = "Wins: " + p_wins + "<br>Losses: " + c_wins + "<br>Draws: " + ties + "<br>% wins: " + ((p_wins / total) * 100).toFixed(0) + "%<br>% losses: " + ((c_wins / total) * 100).toFixed(0) + "%<br>% draws: " + ((ties / total) * 100).toFixed(0) + "%"
}
